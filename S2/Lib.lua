...
function Kavo.CreateLib(kavName, themeList)
    ...
    local ImgBkg = Instance.new("ImageLabel")
    ...
    if themeList.img then
        ImgBkg.Name = "Main"
    	ImgBkg.Parent = Main
    	ImgBkg.ClipsDescendants = true
   	ImgBkg.Position = UDim2.new(0.336503863, 0, 0.275485456, 0)
    	ImgBkg.Size = UDim2.new(0, 525, 0, 318)
    	ImgBkg.Image = "rbxassetid://"..themeList.img
    end
